...
// Define the inline function to update the inputRuleString
  ...
  Future<void> handleFileSelection(FilePickerResult? result,
    ...
    if (result != null) {
      setState(() {
        ...
        _resultController.text =
            '$title selected: $fileName'; // Append to the existing text
      });
    } else {
      setState(() {
        fileName = 'No file selected';
        controller.text = fileName;
        _resultController.text =
            '$title: $fileName'; // Append to the existing text
      });
    }
  }
  ...
  Widget build(BuildContext context) {
    lineNumber = 0;
    Widget scrollableTopContainer = ConstrainedBox(
                        ...
                        if (firstButtonText == 'Validate Data') {
                          showDialog(
                            ...
                            builder: (BuildContext context) {
                              return Center(
                                child: Container(
                                  width: width100 * 0.6, // Adjust the width
                                  height: width100 * 0.4, // Adjust the height
                                  padding: EdgeInsets.all(20.0),
                                  decoration: BoxDecoration(
                                    borderRadius: BorderRadius.circular(20.0),
                                    border: Border.all(
                                        color: Color(0xFF3A4F39), width: 4),
                                    color: Colors.white,
                                  ),
                                  child: Column(
                                    mainAxisAlignment: MainAxisAlignment.center,
                                                                ...
                                                                ElevatedButton(
                                                                  ...
                                                                  onPressed:
                                                                    ...
                                                                    setState(
                                                                        () {
                                                                      samplePercentage =
                                                                          int.tryParse(_samplePercentageController.text) ??
                                                                              0;
                                                                    });
                                                                    Navigator.of(
                                                                            context)
